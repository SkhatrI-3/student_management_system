    ...
    <div class="container-fluid m-1">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3 m-3">Provide The Assignment</h1>
                <form action="{{route('assignments.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label"> Name Of The Assignment</label>
                        <input type="text" class="form-control" autofocus name="name" id="name" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="description" id="description" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="deadline" id="deadline" aria-describedby="emailHelp">
                    </div>
