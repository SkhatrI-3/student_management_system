    ...
    <div class="container-fluid m-4 ">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">Provide The Assignment</h1>
                <form action="{{route('assignments.update',$assignment->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="name" id="name" aria-describedby="emailHelp" value="{{$assignment->name}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="description" id="description" aria-describedby="emailHelp" value="{{$assignment->description}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="file" id="file" aria-describedby="emailHelp" value="{{$assignment->file}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="deadline" id="deadline" aria-describedby="emailHelp" value="{{$assignment->deadline}}">
                    </div>
