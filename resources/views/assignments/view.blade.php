...
<h2 class="breadcrumb-item text-center mt-1"><a class="text-center" href="{{route('teacher.home')}}">GO TO DASHBOARD  </a></h2>

</div>
    <div class="container-fluid m-4 ">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">View The Assignment</h1>
                <form action="{{route('assignments.index')}}"  enctype="multipart/form-data">


                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label"> Name Of The Assignment</label>
                        <input type="text" class="form-control" readonly autofocus name="name" id="name" aria-describedby="emailHelp" value="{{$assignment->name}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" readonly autofocus name="description" id="description" aria-describedby="emailHelp" value="{{$assignment->description}}">
                        <p class="text-danger error-message">@error('description')
                            {{ $message}}
                          @enderror</p>
                    </div>
                    <div class="mb-3">
                        <label for="file" class="form-label">Project</label>
                         <!-- Display the previous image if it exists -->
                         <input type="text" class="form-control" readonly autofocus name="file" id="file" aria-describedby="emailHelp" value="{{$assignment->file}}">

                        <p class="text-danger error-message ">@error('file')
                            {{ $message}}
                          @enderror</p>
                    </div>
                    <div class="mb-3">
                        <label for="deadline" class="form-label">Deadline</label>
                        <input type="date" class="form-control" readonly name="deadline" id="deadline" aria-describedby="emailHelp" value="{{$assignment->deadline}}">
                    </div>
                    <p   class="text-danger error-message">@error('deadline')
                        {{ $message}}
                      @enderror</p>
                    
                 
                    <div class="text-center m-2 ">
                        <button type="submit" name="submit" class="btn btn-info  w-100 ">RETURN</button>
                      </div>
