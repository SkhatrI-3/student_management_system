...
<body class="antialiased">
    ...
    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>CHECK THE STATUS OF  {{$student->std_name}}</h1>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-around align-item-center">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">Check the status of your student {{$student->std_name}}  </h1>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="" class="form-control" autofocus name="date" id="date"
