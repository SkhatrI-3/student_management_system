...
<body class="antialiased">
    ...
    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>Edit THE STATUS OF {{ $attendance->student->std_name }}</h1>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-around align-item-center">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">Edit the status of your student
                    {{ $attendance->student->std_name }} </h1>
                <form action="{{ route('attendances.update', $attendance->id) }}" method="post"
                    ...
                    <div class="row mb-3">
                        <label for="status" class="col-md-12 col-form-label text-md-start">Status</label>
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="" class="form-control" autofocus name="date"
                                    id="date" aria-describedby="emailHelp" value="{{ $attendance->date }}">
                    ...
                    <div class="text-center m-2">
                        <button type="submit" name="submit" class="btn btn-info w-100">Update</button>
                    </div>
                </form>
            </div>
        </div>
