...
$user = auth()->user();
    ...
    @endif
            <h2>HERE YOU CAN MANAGE YOUR  ASSIGNMENTS DIGITALLY</h2>
        <p>EFFICIENT AND EASY TO USE</p>
    </div>
    <div class="container-fluid ">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="item" data-aos="fade-up">
                <a class="fs-1 " href="{{ route('submissions.create') }}">SUBMIT ASSIGNEMNT</a>
            </div>
            <div class="item" data-aos="fade-up">
                <a  href="{{ route('submissions.index') }}">VIEW ASSIGNMENT</a>
            </div>
            <div class="item fs-1" data-aos="fade-up">
                <a href="{{ route('assignments.givenAssignments') }}">GIVEN ASSIGNMENTS</a>
            </div>
