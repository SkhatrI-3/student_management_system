...
<body class="antialiased" >
    ...
    {{-- @php
        $student= \App\Models\Student::where('teacher_id','=',$teacher->id);
    @endphp --}}

    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>ADD YOUR STUDENTS</h1>
    ...
    <div class="container-fluid m-4">
        ...
        <div class="d-flex justify-content-around align-item-center">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">Add your Students</h1>
                ...
                <form action="{{ route('students.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-danger error-message">@error('name'){{ $message }}@enderror</p>
                    </div>
                    <div class="mb-3">
                        <label for="roll" class="form-label">Roll Number</label>
                        <input type="number" class="form-control" name="roll" id="roll" aria-describedby="emailHelp">
                        <p class="text-danger error-message">@error('roll'){{ $message }}@enderror</p>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="class" class="form-label">Class</label>
                            <input type="number" class="form-control" name="class" id="class" aria-describedby="emailHelp">
                            <p class="text-danger error-message">@error('class'){{ $message }}@enderror</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="section" class="form-label">Section</label>
                            <input type="text" class="form-control" name="section" id="section" aria-describedby="emailHelp">
                            <p class="text-danger error-message">@error('section'){{ $message }}@enderror</p>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="subject" class="form-label">Subject</label>
                        <input type="text" class="form-control" name="subject" id="subject" aria-describedby="emailHelp">
                        <p class="text-danger error-message">@error('subject'){{ $message }}@enderror</p>
                    </div>
