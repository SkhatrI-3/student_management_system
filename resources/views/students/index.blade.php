...
<body class="antialiased" >
    ...
    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>SEE YOUR STUDENTS</h1>
        <h2>HERE YOU CAN MANAGE YOUR STUDENTS DIGITALLY</h2>
        <p>EFFICIENT AND EASY TO USE</p>
    </div>
</div class="w-100 text-center">
<h2 class="breadcrumb-item text-center mt-4"><a class="text-center" href="{{route('teacher.home')}}">GO TO DASHBOARD  </a></h2>
    ...
    <div class="container">
        ...
        <div class="add w-100 text-center d-flex justify-content-center align-item-center ">
            ...
            <a class="text-center text-decoration-none m-3 teacher fs-4 w-100 text-secondary" href="{{route('students.create')}} ">Add students</a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($attendance)
                        <a href="{{ route('attendances.edit', $attendance->id) }}" class="btn btn-primary btn-sm m-2">
                        ...
                        <a href="{{route('students.show',$student->id)}}" class="btn btn-info btn-sm m-2">View</a>
                        <a href="{{route('students.edit',$student->id)}}" class="btn btn-primary btn-sm m-2">Edit</a>
                        <form action="{{route('students.destroy',$student->id)}}" method="post" class="d-inline" onclick="return confirm('Are you sure you want to delete this data?')">
                            @csrf
                            @method('DELETE')
