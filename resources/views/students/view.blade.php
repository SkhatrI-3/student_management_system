...
<body class="antialiased">
    ...
    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>VIEW YOUR STUDENT </h1>
        <h2>HERE YOU CAN VIEW YOUR STUDENTS DIGITALLY</h2>
    ...
    <div class="container-fluid m-4 ">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary">View your student {{$student->std_name}}</h1>
                <form action="{{ route('students.index') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input readonly type="text" class="form-control" name="name" id="name"
                            aria-describedby="emailHelp" value={{ $student->std_name }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" readonly class="form-control" name="roll" id="roll"
                            aria-describedby="emailHelp" value={{ $student->std_roll }}>
                        <p class="text-danger error-message">
                            @error('roll')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" readonly name="class" id="class"
                            aria-describedby="emailHelp" value={{ $student->std_class }}>
                    </div>
                    <p class="text-danger error-message">
                        @error('class')
                            {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" readonly name="section" id="section"
                            aria-describedby="emailHelp" value={{ $student->std_section }}>
                    </div>
                    <p class="text-danger error-message">
                        @error('section')
                            {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input readonly type="text" class="form-control" name="subject" id="subject"
                            aria-describedby="emailHelp" value={{ $student->std_subject }}>
                    </div>
                    <p class="text-danger error-message">
                        @error('subject')
                            {{ $message }}
