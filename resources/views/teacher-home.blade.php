...
<body class="antialiased">
    ...
    <div class=" hero container-fluid">
        @if (Auth::check())
            ...
            <h1 style="color: #F8DA85">{{ Auth::user()->name }}</h1>
        @endif
    ...
    <div class="container-fluid ">
        ...
        <div class="d-flex justify-content-around align-item-center ">
            <div class="item" data-aos="fade-up">
                <a class="fs-1 " href="{{ route('students.create') }}">INSERT STUDENTS</a>
            </div>
            <div class="item" data-aos="fade-up">
                <a href="{{ route('students.index') }}">VIEW STUDENTS</a>
            </div>
            <div class="item fs-1" data-aos="fade-up">
                <a href="{{ route('assignments.create') }}">PROVIDE ASSIGNMENTS</a>
            </div>
        </div>
        <div class="d-flex justify-content-around align-item-center ">
            ...
            <div class="item fs-1" data-aos="fade-up">
                <a href="{{  route('teachers.viewAssignments') }} ">VIEW SUBMITTED ASSIGNMENTS</a>
            </div>
        </div>
        </div>
