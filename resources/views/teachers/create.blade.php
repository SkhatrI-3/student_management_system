...
{{-- @php
        $user = auth()->user()->role=='teacher';

@endphp --}}
    <div class=" hero container-fluid" data-aos="fade-up">
        <h1>ADD YOUR TEACHERS</h1>
    ...
    <div class="container-fluid m-4 ">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary text-center fs-3">Add your teachers</h1>
                ...
                <form action="{{route('teachers.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class=" mb-3">
                        <label for="subject" class="col-md-4 col-form-label text-md-start">{{ __('Full Name') }}</label>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-danger error-message ">@error('image')
                            {{ $message}}
                          @enderror</p>
                    </div>
                    <div class="mb-3">
