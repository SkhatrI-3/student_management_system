    ...
    <div class="container-fluid m-4">
        <div class="d-flex justify-content-around align-item-center ">
            <div class="" data-aos="fade-up">
                <h1 class="text-secondary">Edit your teachers</h1>
                <form action="{{ route('teachers.update', $teacher->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="select-container">
                            <select id="teacher" class="form-control" name="teacher" >
                                @foreach ($teachers as $teacherId => $teacher_name)
                                <option value="{{ $teacher_name }}" {{ $teacherId == $teacher->id ? 'selected' : '' }}>
                                    {{ $teacher_name }}
                                </option>
                            @endforeach                    
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="subject" id="subject" aria-describedby="emailHelp"  value={{$teacher->teacher_sub}}>
                    </div>
                    <p   class="text-danger error-message">@error('subject')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control"  name="class" id="class" aria-describedby="emailHelp"  value={{$teacher->class}}>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control"  name="section" id="section" aria-describedby="emailHelp"  value={{$teacher->section}}>
                    </div>
